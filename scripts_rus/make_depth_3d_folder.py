...
def image3d_processing(image, depth, height, width):
...
def chunk_processing(extracted_frames):
    ...
    for frame_path in extracted_frames:
        ...
        left_image, right_image = image3d_processing(image, depth, height, width)
...
def run_processing():
    ...
    # Счетчик общего количества фреймов
